...
<div class="container-fluid animated fadeIn">
    <div class="col-xs-12">
        ...
        <div class="emp-form">
            <form class="form-horizontal pt0" role="form" action="EmployeeBy_newlyAdd.action" method="post">
                <!-- 员工账户信息 -->
                <div class="page-header">
                    <h5>
                        员工账户信息
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="text" class="form-control" id="account" placeholder="Setting account" name="employee_Name">
                          
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="password" class="col-sm-2 control-label">身份证</label>
                    <div class="col-sm-4">
                        <input type="password" class="form-control" id="password" placeholder="Setting password" name="employee_Id_No">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="realname" class="col-sm-2 control-label">毕业学校</label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control" id="realname" placeholder="Real name" name="school_Tag">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="tel" class="form-control" id="telphone" placeholder="Telphone number" name="phone_No">
                    </div>
                </div>
                <div class="form-group">
                    <label for="birthday" class="col-sm-2 control-label">出生日期</label>
                    <div class="col-sm-4">
                        <input type="date" class="form-control" id="birthday" placeholder="Date of birth" name="born_Date">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <button type="reset" class="btn btn-warning btn-lg mr5"><a href="/erp/jsps/employee/addEmp.jsp">重置</a></button>
